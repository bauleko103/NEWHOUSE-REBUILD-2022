...
namespace NEWHOUSE_REBUILD_2022.Controllers
{
    public class AdminSanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TuaDe,TuaDePhu,HinhGioiThieu,HinhChinh,ViTri")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TuaDe,TuaDePhu,HinhGioiThieu,HinhChinh,ViTri")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
